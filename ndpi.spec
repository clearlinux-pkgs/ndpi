...
Version  : 3.4
Release  : 16
URL      : https://github.com/ntop/nDPI/archive/3.4/nDPI-3.4.tar.gz
Source0  : https://github.com/ntop/nDPI/archive/3.4/nDPI-3.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605464116
...
cp %{_builddir}/nDPI-3.4/COPYING %{buildroot}/usr/share/package-licenses/ndpi/e203d4ef09d404fa5c03cf6590e44231665be689
cp %{_builddir}/nDPI-3.4/packages/ubuntu/debian/COPYRIGHT %{buildroot}/usr/share/package-licenses/ndpi/dfac199a7539a404407098a2541b9482279f690d
%make_install
