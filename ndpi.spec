...
Source0  : https://github.com/ntop/nDPI/archive/3.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595366894
...
cp %{_builddir}/nDPI-3.2/COPYING %{buildroot}/usr/share/package-licenses/ndpi/e203d4ef09d404fa5c03cf6590e44231665be689
cp %{_builddir}/nDPI-3.2/packages/ubuntu/debian/COPYRIGHT %{buildroot}/usr/share/package-licenses/ndpi/dfac199a7539a404407098a2541b9482279f690d
%make_install
